# FastTTS 0.1.2 â€” Unified, Zero-Bloat TTS Backend Orchestration for Java
...
**âš¡ Connect multiple TTS backends with a unified interface â€” Minimalist text-to-speech orchestration supporting offline and cloud providers.**
...
- **100% Native JVM Pipeline** â€” Orchestrates multiple TTS backends in a single JVM process with unified interface.
- **Offline and Cloud Support** â€” Seamlessly switch between local models (Piper) and cloud providers (ElevenLabs, Deepgram).
- **Model Agnostic** â€” Works with offline ONNX models, system voices, and cloud APIs through the same `FastTTSBackend` interface.
- **Zero Configuration Overlap** â€” Integrates seamlessly with existing FastJava ecosystem libraries.

---

## Key Features

* **ðŸŽ­ Multiple Backend Support** â€” Unified interface for Piper (offline), Windows SAPI (system), ElevenLabs (cloud), and Deepgram (cloud).
* **ðŸ“± Offline Capable** â€” Run TTS locally with Piper models without internet connection.
* **â˜ï¸ Cloud Integration** â€” Access high-quality cloud voices from ElevenLabs and Deepgram.
* **âš¡ Performance Focused** â€” Built for low-latency synthesis with detailed timing metrics.
* **ðŸ”Œ Simple API** â€” Clean, intuitive interface for text-to-speech synthesis.
...
**FastTTS (This Library â€” The Orchestration Layer)**  
...
1. ðŸŽ­ **[FastTTS-0.1.2.jar](https://github.com/andrestubbe/FastTTS/releases/download/0.1.2/FastTTS-0.1.2.jar)** (TTS Engine)
2. âš™ï¸ **[fastcore-0.1.0.jar](https://github.com/andrestubbe/FastCore/releases/download/0.1.0/fastcore-0.1.0.jar)** (Required Native JNI Loader)
...
- **No installation required** â€” uses Windows built-in voices
...
- [FastCore](https://github.com/andrestubbe/FastCore) â€” Native JNI loader for FastJava libraries
- [FastAudioPlayer](https://github.com/andrestubbe/FastAudioPlayer) â€” Native audio playback for Java via WASAPI
- [FastAI](https://github.com/andrestubbe/fastai) â€” Unified lightweight AI model client interface
- [FastAIModel](https://github.com/andrestubbe/FastAIModel) â€” Embedded GGUF and ONNX runtimes for local feature embeddings
- [FastAIRag](https://github.com/andrestubbe/FastAIRag) â€” Unified, zero-bloat RAG pipeline client for Java
- [FastAIVectorDB](https://github.com/andrestubbe/FastAIVectorDB) â€” High-speed native C++ SIMD vector database
- [FastContentParse](https://github.com/andrestubbe/FastContentParse) â€” Standardized Java document parser for text extraction
- [FastContentChunk](https://github.com/andrestubbe/FastContentChunk) â€” High-performance native SIMD tokenizer and chunker
